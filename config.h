...
static const char *fonts[]          = { "TerminessNerdFontPropo:size=12" };
...
static const int refreshrate = 99999;  /* refresh rate (per second) for client move/resize */

static const unsigned int gappx     = 4;        /* gap pixel between windows */

/* systray */
static const unsigned int systrayspacing       = 2;
static const int systraypinningclientfirst     = 1;
...
static const Layout layouts[] = {
	...
	{ "[tile]",      tile },    /* no layout function means floating behavior */
	{ "[monocle]",      monocle },
};
...
static const Key keys[] = {
    ...
    { MODKEY|ShiftMask,             XK_d,      spawn,          {.v = powermenu } },
	{ 0,                          XK_Print,  spawn,          {.v = printfull } },
	{ MODKEY,                     XK_Print,  spawn,          {.v = printselect } },
	{ MODKEY,	               XK_p,      spawn,          {.v = (const char*[]){ "betterlockscreen", "-l", NULL } } },
	{ MODKEY,			XK_a,	   spawn,	   {.v = pvcmd } },
